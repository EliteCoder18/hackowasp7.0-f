...
function Verify() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-purple-50 flex flex-col items-center py-20 px-4 relative overflow-hidden select-none">
      ...
      <div className="w-full max-w-3xl relative z-10">
        ...
        <motion.div 
          className="bg-white/90 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-200/50 overflow-hidden"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.4 }}
        >
          {/* Tab Selection */}
          <div className="grid grid-cols-2 gap-px bg-gray-100 p-1 mb-6 rounded-t-xl">
            <motion.button
            ...
            {verifyMethod === 'hash' ? (
              ...
              >
                ...
                <motion.button
                  ...
                  className={`relative bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-6 py-3 rounded-xl w-full font-semibold transition-all transform ${
