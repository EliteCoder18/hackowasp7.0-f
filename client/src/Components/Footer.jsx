...
export default function Footer() {
  return (
    <footer className="bg-black text-white p-8 relative overflow-hidden">
      {/* Glow effect */}
      ...
      <div className="max-w-6xl mx-auto mb-16">
        <div className="bg-gray-900 rounded-lg p-10 relative overflow-hidden">
          {/* Glow effect around the box */}
          <div className="absolute inset-0 bg-gradient-to-r from-green-400 via-blue-500 to-purple-500 opacity-30 blur-xl"></div>
          
          <div className="relative flex flex-col md:flex-row justify-between items-center gap-4">
            <h2 className="text-3xl font-bold">
            Secure your creations - be it art or code <br></br>and share them confidently
            </h2>
            
            <div className="flex w-full md:w-auto">
             
              <button className="bg-black text-white px-4 py-2 rounded-md border border-white">
                Join Now
              </button>
            </div>
          </div>
